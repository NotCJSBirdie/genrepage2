			...
			<Grid container spacing={0.5}>
				<Grid item xs={2.4}>
					<Card sx={{ maxWidth: 250, boxShadow: 7 }}>
						<CardContent>
							<img alt="" src={Pic6} className="cardpictures" />
				...
				<Grid item xs={2.4}>
					<Card sx={{ maxWidth: 250, boxShadow: 7 }}>
						<CardContent>
							<img alt="" src={Pic7} className="cardpictures" />
							<h6 className="cardfont">Аналоговый 4-дюймовый</h6>
							<h6 className="cardfont">
								видеодомофон с сенсорными
							</h6>
				...
				<Grid item xs={2.4}>
					<Card sx={{ maxWidth: 250, boxShadow: 7 }}>
						<CardContent>
							<img alt="" src={Pic8} className="cardpictures" />
							<h6 className="cardfont">Аналоговый 4-дюймовый</h6>
							<h6 className="cardfont">
								видеодомофон с сенсорными
							</h6>
				...
				<Grid item xs={2.4}>
					<Card sx={{ maxWidth: 250, boxShadow: 7 }}>
						<CardContent>
							<img alt="" src={Pic9} className="cardpictures" />
							<h6 className="cardfont">Аналоговый 4-дюймовый</h6>
							<h6 className="cardfont">
								видеодомофон с сенсорными
							</h6>
				...
				<Grid item xs={2.4}>
					<Card sx={{ maxWidth: 250, boxShadow: 7 }}>
						<CardContent>
							<img alt="" src={Pic10} className="cardpictures" />
							<h6 className="cardfont">Аналоговый 4-дюймовый</h6>
							<h6 className="cardfont">
								видеодомофон с сенсорными
							</h6>
